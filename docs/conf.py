...
latex_documents = [
    (master_doc, 'schurtransform.tex', 'schurtransform Documentation',
     'James Mathews', 'manual'),
]
...
man_pages = [
    (master_doc, 'schurtransform', 'schurtransform Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'schurtransform', 'schurtransform Documentation',
     author, 'schurtransform', 'One line description of project.',
     'Miscellaneous'),
]
